...
Definition ivucx_json_truncated : string :=
  ivucx_json_object [
    ivucx_json_field "kind" (ivucx_json_string "truncated")
  ].

Fixpoint ivucx_json_term_fuel (fuel : nat) (t : term) {struct fuel} : string :=
  match fuel with
  | O => ivucx_json_truncated
  | S fuel' =>
      let fix ivucx_json_term_items (items : list term) : string :=
        match items with
        | [] => ""
        | [item] => ivucx_json_term_fuel fuel' item
        | item :: rest => ivucx_json_term_fuel fuel' item +s "," +s ivucx_json_term_items rest
        end in
      let fix ivucx_json_branch_items (items : list (branch term)) : string :=
        match items with
        | [] => ""
        | [item] =>
            ivucx_json_object [
              ivucx_json_field "names" (ivucx_json_aname_array (bcontext item));
              ivucx_json_field "body" (ivucx_json_term_fuel fuel' (bbody item))
            ]
        | item :: rest =>
            ivucx_json_object [
              ivucx_json_field "names" (ivucx_json_aname_array (bcontext item));
      ...
      let fix ivucx_json_def_items (items : list (def term)) : string :=
        match items with
        | [] => ""
        | [item] =>
            ivucx_json_object [
              ...
              ivucx_json_field "type" (ivucx_json_term_fuel fuel' (dtype item));
              ivucx_json_field "body" (ivucx_json_term_fuel fuel' (dbody item));
      ...
      | tCast tm kind ty =>
          ivucx_json_object [
            ...
            ivucx_json_field "term" (ivucx_json_term_fuel fuel' tm);
            ivucx_json_field "type" (ivucx_json_term_fuel fuel' ty)
          ]
      | tProd na ty body =>
          ivucx_json_object [
            ...
            ivucx_json_field "relevance" (ivucx_json_string (string_of_relevance (binder_relevance na)));
            ivucx_json_field "type" (ivucx_json_term_fuel fuel' ty);
            ivucx_json_field "body" (ivucx_json_term_fuel fuel' body)
          ]
      | tLambda na ty body =>
          ivucx_json_object [
      ...
      | tLetIn na def def_ty body =>
          ivucx_json_object [
            ...
            ivucx_json_field "name" (ivucx_json_name (binder_name na));
            ivucx_json_field "relevance" (ivucx_json_string (string_of_relevance (binder_relevance na)));
            ivucx_json_field "type" (ivucx_json_term_fuel fuel' def_ty);
            ivucx_json_field "value" (ivucx_json_term_fuel fuel' def);
            ivucx_json_field "body" (ivucx_json_term_fuel fuel' body);
      ...
      | tApp f args =>
          ivucx_json_object [
            ...
            ivucx_json_field "fn" (ivucx_json_term_fuel fuel' f);
            ivucx_json_field "args" ("[" +s ivucx_json_term_items args +s "]")
          ]
      | tConst c u =>
          ivucx_json_object [
          ...
          ivucx_json_object [
            ...
            ivucx_json_field "predicate" (
              ivucx_json_object [
                ...
                ivucx_json_field "returnType" (ivucx_json_term_fuel fuel' (preturn type_info))
              ]
            );
            ivucx_json_field "discriminant" (ivucx_json_term_fuel fuel' discr);
      ...
      | tProj proj tm =>
          ivucx_json_object [
            ...
            ivucx_json_field "struct" (ivucx_json_term_fuel fuel' tm)
          ]
      | tFix defs idx =>
          ivucx_json_object [
      ...
      | tArray u items default_value item_type =>
          ivucx_json_object [
            ...
            ivucx_json_field "default" (ivucx_json_term_fuel fuel' default_value);
            ivucx_json_field "type" (ivucx_json_term_fuel fuel' item_type)
          ]
      end
  end.

Definition ivucx_json_term (t : term) : string :=
  ivucx_json_term_fuel 20000 t.
